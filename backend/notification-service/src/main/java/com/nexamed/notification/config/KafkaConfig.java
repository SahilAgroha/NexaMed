...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, EnrollmentEvent> enrollmentConsumerFactory() {
        ...
        mapper.registerModule(new JavaTimeModule()); // handles LocalDateTime in event

        JsonDeserializer<EnrollmentEvent> deserializer =
                new JsonDeserializer<>(EnrollmentEvent.class, mapper);
        deserializer.addTrustedPackages("*");
        deserializer.setUseTypeHeaders(false); // don't require type headers from producer
